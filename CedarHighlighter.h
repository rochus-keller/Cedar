#ifndef CEDARHIGHLIGHTER_H
#define CEDARHIGHLIGHTER_H
...
namespace Cedar
{
    ...
    private:
        enum Category { C_Num, C_Str, C_Kw, C_Type, C_Ident, C_Op, C_Pp, C_Cmt, C_Label, C_Sym, C_Max };
